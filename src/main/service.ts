...
// 2024-07-12更新
// record记录类：用于记载上次爬取到的文章列表数据进度
class ProccessRecord {
  public description = "上次爬取任务数据列表的最后一次offsset值";
  public lastOffset: number;

  constructor(lastOffset: number) {
    this.lastOffset = lastOffset
  }
}

export { GzhInfo, ArticleInfo, ArticleMeta, PdfInfo, DownloadOption, FilterRuleInfo, NodeWorkerResponse, Service, NwrEnum, DlEventEnum, ProccessRecord};
